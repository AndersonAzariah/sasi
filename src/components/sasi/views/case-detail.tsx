...
export default function CaseDetailView() {
  ...
  const shareLabel = "Sharing is coming soon — demo";
            ...
            {shareOpen && (
              <>
                ...
                <div
                  ...
                  className="sasi-card absolute right-0 top-11 z-50 w-64 bg-[#0d0e10] p-3.5 shadow-xl shadow-black/50"
                >
                  <p className="text-[12.5px] font-medium text-white">
                    {shareLabel}
                  </p>
                  <p className="mt-1 text-[12px] leading-relaxed text-zinc-500">
                    Case sharing is not available in this demo environment.
                  </p>
